...
var installCleanners = function (isReact) {
    return "npm i " + (!isReact ? 'eslint' : '') + " eslint-config-prettier prettier " + packageCleaners.join(' ');
};
exports.installCleanners = installCleanners;
var ignore = ".next\nnode_modules\n.eslintcache\n.vscode\ncoverage\nbabel-config.js\npackage.json\n.eslintcache\n";
...
var cleanners = function (isReact) { return [
    exports.installCleanners(isReact),
    exports.prettier,
